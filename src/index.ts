...
import { listPhotosByApp, findDevice, listDevice, importPhotos } from "./api";
...
const composeReply = (data: any) => ({ status: "success", data: data });
const composeError = (e: Error) => ({
  status: "error",
